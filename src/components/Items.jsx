...
<Card className='cardsContainer' style={{ width: '24rem', height: '34rem', margin: '1.25rem' }}>
      ...
      <ListGroup className="list-group-flush" style={{fontSize:'0.9rem'}}>
        <ListGroup.Item style={{fontWeight:"600"}}>Incluye: {items.include[0]}</ListGroup.Item>
        <ListGroup.Item style={{fontWeight:"600"}}>Duración del tour:{items.duration}</ListGroup.Item>
